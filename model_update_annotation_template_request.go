...
// checks if the UpdateAnnotationTemplateRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateAnnotationTemplateRequest{}

// UpdateAnnotationTemplateRequest struct for UpdateAnnotationTemplateRequest
...
func NewUpdateAnnotationTemplateRequest(name string, type_ string) *UpdateAnnotationTemplateRequest {
	this := UpdateAnnotationTemplateRequest{}
	this.Name = name
	this.Type = type_
	return &this
}
...
func (o UpdateAnnotationTemplateRequest) MarshalJSON() ([]byte, error) {
...
func (o UpdateAnnotationTemplateRequest) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateAnnotationTemplateRequest struct {
	value *UpdateAnnotationTemplateRequest
	isSet bool
}

func (v NullableUpdateAnnotationTemplateRequest) Get() *UpdateAnnotationTemplateRequest {
	return v.value
}

func (v *NullableUpdateAnnotationTemplateRequest) Set(val *UpdateAnnotationTemplateRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateAnnotationTemplateRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateAnnotationTemplateRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateAnnotationTemplateRequest(val *UpdateAnnotationTemplateRequest) *NullableUpdateAnnotationTemplateRequest {
	return &NullableUpdateAnnotationTemplateRequest{value: val, isSet: true}
}

func (v NullableUpdateAnnotationTemplateRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateAnnotationTemplateRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
